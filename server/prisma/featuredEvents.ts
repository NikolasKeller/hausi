// The curated YE Munich events shown on the discovery surfaces (Home / Explore).
// Shared by the full seed (prisma/seed.ts, wipes + recreates) and the additive
// upsert (prisma/add-events.ts, safe for production — never deletes anything).
