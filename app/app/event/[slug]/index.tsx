...
// own shop). Older scraped events instead carried the link as the last URL in
// the description; for those we fall back to extracting it and stripping it
// from the displayed copy so the button still works and no raw URL shows.
